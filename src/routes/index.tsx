      ...
      <section className="container mx-auto px-4 pt-6 pb-12 lg:pt-16 lg:pb-20">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-tight">
            Za <span className="brand-text-gradient">2&nbsp;€</span> ušetríš ročne
            <br />
            <span className="brand-text-gradient">stovky eur</span> na energiách
          </h1>
          <p className="mt-4 text-base sm:text-lg text-muted-foreground">
            Denne porovnávame ceny <strong>všetkých</strong> dodávateľov elektriny a plynu na Slovensku.
            Povieme ti presne, kde a koľko ušetríš.
          </p>
        </div>
              ...
              {segment === "household" ? (
                <>
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Odpovedz na 5 otázok (región, spotreba, dodávateľ) a za 2 € dostaneš
                    personalizovaný report: TOP 3 najlacnejší dodávatelia + presná ročná úspora
                    v eurách + krok-za-krokom postup, ako prejsť.
                  </p>
                </>
              ) : (
                <>
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Vyplň krátky dotazník (IČO, spotreba, aktuálny dodávateľ).
                    Vypracujeme ti ponuku <strong>na mieru</strong> a pošleme do 24 hodín na email.
                  </p>
                </>
              )}
              <Link to="/kalkulacka">
